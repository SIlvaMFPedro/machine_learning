...
class Network(object):
    ...
    """ 
        This conv function is currently using a bias 
    """
    ...
    """
        Get Weights Dictionary Function
    """
    def get_weigths_dict(self):
        return self._weights

    """
        Get Feature Tensors Dictionary Function
    """
...
# ------------------------------------------
#   Load Imitation Learning Network Function
# ------------------------------------------
